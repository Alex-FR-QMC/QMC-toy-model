# QMC-toy-model - Chapter 1 realization

Minimal discrete dynamical model illustrating the morphodynamic collapse described in the QMC (Quantum Meta-Cognition) paradigm.
...
Quemeneur, A. (2026). *A Morphodynamic Theory of Cognitive Viability: Foundations of the QMC Paradigm* (Chapter 1). arXiv preprint.
[lien arXiv à ajouter]
